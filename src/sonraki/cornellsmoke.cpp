...
HittableList cornell_box() {
  ...
  // ---------- materials -----------------
  auto black = make_shared<SolidColor>(color(0));
  auto bright = make_shared<SolidColor>(color(0.9));
  ...
  scene.add(make_shared<ConstantMedium>(box1, 0.01, black));
  scene.add(make_shared<ConstantMedium>(box2, 0.01, bright));
