...
//
#include <custom/haftasonu/commons.hpp> // vek3, ray
//
#include <custom/haftasonu/hittable.hpp>
//
#include <custom/haftasonu/material.hpp>

class Sphere2 : public Hittable {
public:
  point3 center;
  double radius;
...
public:
  Sphere2() {}
  Sphere2(point3 cent, double r) : center(cent), radius(r) {}
